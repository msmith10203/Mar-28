...
- (id)initWithFrame:(CGRect)frame
{
	...
	if (self) {
        ...
        UIFont *headerFont = [UIFont italicSystemFontOfSize: 32];
        ...
        [self installSwitchX: 170 installSwitchY: 160];
        NSString *text = @"Green ";
...
-(void) installSwitchX: (float) x installSwitchY: (int) y
{
    ...
    self.mySwitch.center = CGPointMake(x, y);
    self.mySwitch.on = NO;	//the default
